...
export const TEMPLATES = Object.freeze({
  ...
  [N.LAYOUT_CHANGED]: d => ({
    subject: 'Раскладка графа переучреждена',
    text: `Узлы графа переставлены. Медианный сдвиг: ${d.медиана} px, `
        + `дальше 200 px уехало узлов: ${d.далеко}.`,
    html: `<h2>Раскладка графа переучреждена</h2>`
        + paragraph('Медианный сдвиг', d.медиана + ' px')
        + paragraph('Узлов дальше 200 px', d.далеко),
  }),
  [N.GRAPH_CHANGED]: d => ({
