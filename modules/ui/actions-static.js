...
registerActions({
  ...
  "switch-stats-view-2": (el, ev) => { switchStatsView('observations'); },
  "switch-stats-view-3": (el, ev) => { switchStatsView('comparison'); },
  "switch-stats-view-4": (el, ev) => { switchStatsView('closest-pairs'); },
  "switch-stats-view-5": (el, ev) => { switchStatsView('philosopher-comparison'); },
  "switch-stats-view-6": (el, ev) => { switchStatsView('philosopher-pairs'); },
  "switch-stats-view-7": (el, ev) => { switchStatsView('degree'); },
  "switch-stats-view-8": (el, ev) => { switchStatsView('pagerank'); },
  "switch-stats-view-9": (el, ev) => { switchStatsView('betweenness'); },
  "switch-stats-view-10": (el, ev) => { switchStatsView('closeness'); },
  "switch-stats-view-11": (el, ev) => { switchStatsView('eigenvector'); },
  "switch-stats-view-12": (el, ev) => { switchStatsView('weighted-clustering'); },
  "switch-stats-view-13": (el, ev) => { switchStatsView('local-cohesion'); },
  "switch-stats-view-14": (el, ev) => { switchStatsView('rich-club'); },
  "switch-stats-view-15": (el, ev) => { switchStatsView('problem-generation'); },
  "switch-stats-view-16": (el, ev) => { switchStatsView('critical-power'); },
  "switch-stats-view-17": (el, ev) => { switchStatsView('tension'); },
  "switch-stats-view-18": (el, ev) => { switchStatsView('revolutionary'); },
  "switch-stats-view-19": (el, ev) => { switchStatsView('paradigm-shift'); },
  "switch-stats-view-20": (el, ev) => { switchStatsView('influence'); },
  "switch-stats-view-21": (el, ev) => { switchStatsView('foundational'); },
  "switch-stats-view-22": (el, ev) => { switchStatsView('synthetic'); },
  "switch-stats-view-23": (el, ev) => { switchStatsView('dialogical'); },
  "switch-stats-view-24": (el, ev) => { switchStatsView('coherence'); },
  "switch-stats-view-25": (el, ev) => { switchStatsView('transformation'); },
  "switch-stats-view-26": (el, ev) => { switchStatsView('fertility'); },
  "switch-stats-view-27": (el, ev) => { switchStatsView('complexity'); },
  "switch-stats-view-28": (el, ev) => { switchStatsView('continuity'); },
  "switch-stats-view-29": (el, ev) => { switchStatsView('generative'); },
  "switch-stats-view-30": (el, ev) => { switchStatsView('instrumental'); },
  "switch-stats-view-31": (el, ev) => { switchStatsView('bridging'); },
  "switch-stats-view-32": (el, ev) => { switchStatsView('abstraction'); },
  "switch-stats-view-33": (el, ev) => { switchStatsView('deductive'); },
  "switch-stats-view-34": (el, ev) => { switchStatsView('temporal-influence'); },
  "switch-stats-view-35": (el, ev) => { switchStatsView('philosopher-profile'); },
  "switch-stats-view-36": (el, ev) => { switchStatsView('philosopher-systematic'); },
  "switch-stats-view-37": (el, ev) => { switchStatsView('philosopher-reach'); },
  "switch-stats-view-38": (el, ev) => { switchStatsView('philosopher-interdisciplinary'); },
  "switch-stats-view-39": (el, ev) => { switchStatsView('concept-rankings'); },
  "switch-stats-view-40": (el, ev) => { switchStatsView('philosopher-rankings'); },
});
