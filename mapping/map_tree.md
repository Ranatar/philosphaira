...
### `modules/util/html.js` — 50 строк, объявлений 5
...
Чаще всего поминает: `escapeAttr`×19, `DATA`×6, `conceptById`×3, `linkIsInternal`×2, `directionMark`×2
