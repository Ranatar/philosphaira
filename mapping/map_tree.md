...
подряд, поэтому таких много (203), и это шум в списке вывоза,
...
|---|---|---|---|---|---|
| `boot.js` | 225 | 0 | 1 | 56 | DATA:2, S:5 |
| `main.js` | 121 | 0 | 0 | 110 | — |
| `modules/boot-defs.js` | 62 | 3 | 3 | 8 | S:1 |
| `modules/core/base-cells.js` | 17 | 0 | 0 | 1 | S:7 |
| `modules/core/events.js` | 43 | 4 | 4 | 0 | — |
...
| `modules/data/mutate.js` | 74 | 3 | 3 | 4 | DATA:11, S:1 |
| `modules/data/save.js` | 72 | 10 | 10 | 1 | DATA:6 |
| `modules/dead.js` | 79 | 4 | 4 | 4 | DATA:1, S:5, MET:1 |
| `modules/filters/beyond-filter.js` | 21 | 2 | 2 | 2 | — |
| `modules/filters/chains.js` | 273 | 6 | 6 | 4 | DATA:3, S:2 |
| `modules/filters/filters.js` | 454 | 14 | 14 | 13 | DATA:4, S:8 |
| `modules/graph/click-actions.js` | 201 | 8 | 8 | 8 | S:1 |
| `modules/graph/graph-data.js` | 112 | 10 | 10 | 9 | DATA:4, S:6 |
| `modules/graph/graph-selection.js` | 55 | 3 | 3 | 3 | S:1 |
| `modules/metrics/by-link-type.js` | 116 | 6 | 6 | 2 | S:3, MET:4 |
| `modules/metrics/concept-dynamics.js` | 224 | 8 | 8 | 2 | S:4, MET:4 |
| `modules/metrics/descriptions.js` | 478 | 2 | 2 | 3 | S:3 |
| `modules/metrics/format.js` | 32 | 4 | 4 | 2 | S:3 |
| `modules/metrics/generativity.js` | 102 | 8 | 8 | 1 | S:6, MET:1 |
| `modules/metrics/graph-cache.js` | 117 | 3 | 3 | 3 | S:3 |
| `modules/metrics/link-indexes.js` | 121 | 4 | 4 | 5 | DATA:3, S:8 |
| `modules/metrics/network.js` | 870 | 25 | 25 | 3 | DATA:1, S:8, MET:9 |
| `modules/metrics/philosopher.js` | 308 | 13 | 13 | 2 | S:5, MET:9 |
| `modules/metrics/philosophical.js` | 1038 | 23 | 23 | 4 | DATA:1, S:6, MET:10 |
| `modules/metrics/rankings.js` | 141 | 5 | 5 | 3 | S:4, MET:9 |
| `modules/metrics/scope-reset.js` | 64 | 3 | 3 | 12 | S:2 |
| `modules/metrics/scope-select.js` | 99 | 6 | 6 | 2 | DATA:2, S:5 |
| `modules/metrics/scope.js` | 135 | 7 | 7 | 8 | DATA:2, S:6 |
| `modules/metrics/similarity-concepts.js` | 243 | 15 | 15 | 3 | S:4, MET:17 |
| `modules/metrics/similarity-philosophers.js` | 160 | 11 | 11 | 2 | S:3, MET:3 |
| `modules/metrics/tension-cache.js` | 13 | 1 | 1 | 1 | S:2 |
| `modules/metrics/tradition-bridging.js` | 70 | 4 | 4 | 1 | S:4, MET:1 |
| `modules/modal/assembly.js` | 54 | 3 | 3 | 1 | — |
| `modules/modal/auth.js` | 162 | 10 | 10 | 4 | — |
| `modules/modal/concept-view.js` | 336 | 1 | 1 | 6 | DATA:6, VIEWS:1 |
| `modules/modal/connection-edit.js` | 283 | 9 | 9 | 11 | DATA:3, VIEWS:1 |
| `modules/modal/connection-view.js` | 414 | 11 | 11 | 9 | DATA:6, VIEWS:1 |
| `modules/modal/context.js` | 11 | 1 | 1 | 0 | — |
| `modules/modal/core.js` | 154 | 7 | 7 | 9 | S:1 |
| `modules/modal/descriptions.js` | 162 | 10 | 10 | 0 | — |
| `modules/modal/dirty.js` | 111 | 5 | 5 | 4 | DATA:3 |
| `modules/modal/edit-forms.js` | 287 | 2 | 2 | 10 | DATA:7, VIEWS:2 |
| `modules/modal/edit-rights.js` | 53 | 3 | 3 | 3 | — |
| `modules/modal/entry.js` | 123 | 12 | 12 | 10 | DATA:4, S:2 |
| `modules/modal/integrity.js` | 253 | 10 | 10 | 6 | DATA:5 |
| `modules/modal/persist.js` | 360 | 10 | 10 | 10 | DATA:9, S:1 |
| `modules/modal/philosopher-view.js` | 620 | 4 | 4 | 11 | DATA:9, VIEWS:1 |
| `modules/modal/profile-concept.js` | 181 | 8 | 8 | 7 | DATA:5, S:3, MET:19 |
| `modules/modal/profile-philosopher.js` | 120 | 2 | 2 | 7 | DATA:6, S:3, MET:3 |
| `modules/modal/search.js` | 43 | 3 | 3 | 1 | — |
| `modules/paths/analysis.js` | 73 | 2 | 2 | 6 | DATA:5 |
| `modules/paths/chronology.js` | 174 | 10 | 10 | 3 | DATA:3, S:1 |
| `modules/paths/path-descriptions.js` | 174 | 4 | 4 | 7 | DATA:3, S:1 |
| `modules/paths/path-ui.js` | 397 | 8 | 8 | 8 | DATA:5, S:7 |
| `modules/paths/shortest-path.js` | 209 | 4 | 4 | 5 | DATA:2, S:4 |
| `modules/render/canvas-core.js` | 45 | 9 | 9 | 3 | S:3 |
| `modules/render/d3-layer.js` | 105 | 11 | 11 | 6 | DATA:2, S:3 |
| `modules/render/draw-link.js` | 98 | 6 | 6 | 5 | S:1 |
| `modules/render/geometry.js` | 95 | 6 | 6 | 3 | DATA:1, S:2 |
| `modules/render/grouping.js` | 103 | 7 | 7 | 6 | DATA:1, S:7 |
| `modules/render/interactions.js` | 307 | 8 | 8 | 18 | DATA:2, S:4 |
| `modules/render/loop.js` | 20 | 4 | 4 | 0 | — |
| `modules/render/metric-visualization.js` | 371 | 10 | 10 | 5 | DATA:4, S:3 |
| `modules/render/picking.js` | 79 | 6 | 6 | 8 | DATA:2, S:1 |
| `modules/render/render-state.js` | 17 | 6 | 6 | 1 | — |
| `modules/render/scene.js` | 244 | 10 | 10 | 13 | DATA:4, S:4 |
| `modules/render/selection.js` | 260 | 8 | 8 | 10 | DATA:2, S:2 |
| `modules/render/similarity-overlay.js` | 112 | 6 | 6 | 7 | DATA:3, S:1 |
| `modules/render/simulation.js` | 126 | 11 | 11 | 10 | DATA:2, S:3 |
| `modules/render/tooltip-el.js` | 7 | 1 | 1 | 1 | — |
| `modules/state/edit.js` | 14 | 2 | 2 | 0 | — |
...
| `modules/state/render.js` | 36 | 2 | 2 | 3 | DATA:2, S:10 |
...
| `modules/stats/results.js` | 392 | 11 | 11 | 4 | S:3 |
| `modules/stats/run.js` | 128 | 4 | 4 | 3 | S:1, MET:6 |
| `modules/stats/views/advanced.js` | 270 | 10 | 10 | 4 | DATA:3, MET:10 |
| `modules/stats/views/comparison.js` | 427 | 10 | 10 | 9 | DATA:4, S:11 |
| `modules/stats/views/network.js` | 223 | 9 | 9 | 4 | DATA:2, S:2, MET:1 |
| `modules/stats/views/philosopher.js` | 171 | 4 | 4 | 6 | DATA:3, MET:3 |
| `modules/stats/views/philosophical.js` | 449 | 12 | 12 | 7 | DATA:3, S:2, MET:10 |
...
| `modules/util/philosopher-label.js` | 39 | 7 | 7 | 2 | DATA:2 |
| `modules/util/ru.js` | 49 | 3 | 3 | 0 | — |
| `modules/widgets/custom-select.js` | 88 | 5 | 5 | 4 | DATA:1, S:4 |
...
| `BUS_EVENTS` | const | 1 | да |
| `busSubscribers` | const | 1 | да |

### `modules/core/graph-index.js` — 99 строк, объявлений 3
...
### `modules/core/link-facts.js` — 42 строк, объявлений 6
...
### `modules/core/search.js` — 72 строк, объявлений 5
...
### `modules/data/mutate.js` — 74 строк, объявлений 3
...
### `modules/dead.js` — 79 строк, объявлений 4
...
### `modules/graph/graph-data.js` — 112 строк, объявлений 10
...
### `modules/metrics/generativity.js` — 102 строк, объявлений 8
...
### `modules/metrics/link-indexes.js` — 121 строк, объявлений 4
...
### `modules/metrics/network.js` — 870 строк, объявлений 25
...
### `modules/metrics/philosophical.js` — 1038 строк, объявлений 23
...
### `modules/metrics/similarity-philosophers.js` — 160 строк, объявлений 11
...
### `modules/metrics/tradition-bridging.js` — 70 строк, объявлений 4
...
### `modules/modal/connection-edit.js` — 283 строк, объявлений 9
...
### `modules/modal/connection-view.js` — 414 строк, объявлений 11
...
### `modules/modal/dirty.js` — 111 строк, объявлений 5
...
### `modules/modal/edit-forms.js` — 287 строк, объявлений 2
...
### `modules/modal/entry.js` — 123 строк, объявлений 12
...
### `modules/modal/integrity.js` — 253 строк, объявлений 10
...
### `modules/modal/persist.js` — 360 строк, объявлений 10
...
### `modules/modal/philosopher-view.js` — 620 строк, объявлений 4

| Имя | Вид | Строк | Вывозится |
|---|---|---|---|
| `makeLegendsEditable` | function | 71 | да |
| `philosopherTraditionsBlock` | function | 37 | да |
| `similarPhilosophersBlock` | function | 31 | да |
| `DATA_traditions_of` | function | 4 | да |

### `modules/modal/profile-concept.js` — 181 строк, объявлений 8
...
### `modules/modal/profile-philosopher.js` — 120 строк, объявлений 2
...
### `modules/paths/analysis.js` — 73 строк, объявлений 2
...
### `modules/paths/chronology.js` — 174 строк, объявлений 10
...
### `modules/paths/path-descriptions.js` — 174 строк, объявлений 4
...
### `modules/paths/path-ui.js` — 397 строк, объявлений 8
...
### `modules/paths/shortest-path.js` — 209 строк, объявлений 4
...
### `modules/render/draw-link.js` — 98 строк, объявлений 6
...
| `philosopherNames` | const | 1 | да |
| `groupPositions` | const | 1 | да |
| `cols` | const | 1 | да |
| `rows` | const | 1 | да |

### `modules/render/interactions.js` — 307 строк, объявлений 8

| Имя | Вид | Строк | Вывозится |
|---|---|---|---|
| `installLinkHover` | function | 127 | да |
| `installNodeDrag` | function | 39 | да |
| `dispatchClick` | function | 34 | да |
...
### `modules/render/scene.js` — 244 строк, объявлений 10
...
### `modules/render/selection.js` — 260 строк, объявлений 8
...
### `modules/render/similarity-overlay.js` — 112 строк, объявлений 6
...
### `modules/state/edit.js` — 14 строк, объявлений 2
...
### `modules/state/render.js` — 36 строк, объявлений 2
...
### `modules/stats/results.js` — 392 строк, объявлений 11

| Имя | Вид | Строк | Вывозится |
|---|---|---|---|
| `generateMetricResults` | function | 142 | да |
...
### `modules/stats/views/advanced.js` — 270 строк, объявлений 10
...
### `modules/stats/views/comparison.js` — 427 строк, объявлений 10
...
### `modules/stats/views/philosophical.js` — 449 строк, объявлений 12
...
| `legendWeightsToggle` | const | 1 | да |
| `legendDirectionToggle` | const | 1 | да |
...
### `modules/ui/search-link.js` — 117 строк, объявлений 6

| Имя | Вид | Строк | Вывозится |
|---|---|---|---|
| `showFoundLinks` | function | 28 | да |
...
| `pickPhilosophers` | function | 11 | да |
...
### `modules/util/philosopher-label.js` — 39 строк, объявлений 7
...
Чаще всего поминает: `subscribe`×24, `S`×12, `updateFilterStats`×5, `DATA`×4, `initializePhilosophyMetrics`×4
...
Чаще всего поминает: `S`×6, `cancelGraphSelection`×4, `closeUniversalModal`×4, `modalStack`×4, `closeDetailModal`×4
...
Чаще всего поминает: `DATA`×30, `S`×4, `emit`×3, `markDirty`×3
...
Чаще всего поминает: `pinnedDespiteFilter`×6, `applyFiltersImmediate`×3, `pinnedVisibleNodes`×3
...
Чаще всего поминает: `S`×64, `DATA`×22, `emit`×11, `showTemporaryMessage`×11, `CHAIN_SEARCH`×10
...
Чаще всего поминает: `selectedEdges`×17, `selectedNodes`×17, `editMode`×10, `emit`×8, `gfxNode`×7
...
Чаще всего поминает: `S`×12, `renderState`×12, `DATA`×9, `emit`×4, `requestDraw`×4
...
Чаще всего поминает: `S`×5, `gfxCanvas`×4, `emit`×3
...
Чаще всего поминает: `S`×13, `MET`×8, `sumWeight`×6
...
Чаще всего поминает: `S`×7, `emit`×3

### `modules/metrics/generativity.js`

- из `modules/core/ns.js`: `MET`, `S`

Чаще всего поминает: `S`×15, `MET`×3
...
Чаще всего поминает: `DATA`×18, `nearestConcepts`×4, `linkArrow`×4, `VIEWS`×3, `medianNodeDegree`×3
...
Чаще всего поминает: `DATA`×10, `openUniversalModal`×7, `canEdit`×5, `S`×4, `getConceptConnections`×4
...
Чаще всего поминает: `displaySearchResults`×3, `pickConcepts`×3
...
Чаще всего поминает: `DATA`×9, `MATURITY_AGE`×6, `CHRONOLOGY_MODES`×5, `S`×4
...
Чаще всего поминает: `S`×9, `nodeAge`×8, `DATA`×7, `isSymmetricLink`×4, `CHRONOLOGY_MODES`×4
...
Чаще всего поминает: `S`×7, `requestDraw`×3
...
Чаще всего поминает: `DATA`×11, `renderState`×10, `requestDraw`×10, `S`×6, `startRadiusAnimation`×3
...
Чаще всего поминает: `hasLinkClass`×6, `renderState`×5, `S`×3, `arcParams`×3, `arrowPoints`×3
...
Чаще всего поминает: `S`×8, `renderState`×4, `DATA`×3
...
Чаще всего поминает: `S`×21, `DATA`×3, `resizeCanvas`×3, `resetHighlight`×3
...
Чаще всего поминает: `S`×17, `tooltip`×14, `renderState`×13, `linkHandlers`×12, `nodeHandlers`×10
...
Чаще всего поминает: `pickCtx`×16, `dpr`×8, `DATA`×7, `pickCanvas`×6, `renderState`×5

### `modules/render/render-state.js`

- из `modules/render/canvas-core.js`: `renderState`

Чаще всего поминает: `renderState`×6
...
- из `modules/render/render-state.js`: `LABEL_ALL_ABOVE`, `LABEL_HIDE_BELOW`, `hasNodeClass`, `nodeLabelDy`, `nodeRadius`
- из `modules/render/similarity-overlay.js`: `similarityColor`
- из `modules/state/render.js`: `selectedNodes`

Чаще всего поминает: `S`×24, `DATA`×17, `renderState`×13, `hasNodeClass`×8, `ctx`×6
...
Чаще всего поминает: `selectedNodes`×13, `chosenPhilosophers`×10, `selectedEdges`×10, `DATA`×8, `gfxNode`×8
...
- из `modules/core/long-task.js`: `showTemporaryMessage`
- из `modules/metrics/link-indexes.js`: `initializePhilosophyMetrics`
- из `modules/metrics/similarity-concepts.js`: `_simCache`, `profileSimilarity`, `structuralSimilarity`
- из `modules/render/loop.js`: `requestDraw`

Чаще всего поминает: `S`×15, `DATA`×6, `showTemporaryMessage`×4, `requestDraw`×4, `emit`×3
...
Чаще всего поминает: `S`×22, `DATA`×5, `ensureAnimLoop`×4, `needsContinuousAnimation`×4, `showTemporaryMessage`×3
...
Чаще всего поминает: `S`×7, `DATA`×6
...
Чаще всего поминает: `S`×9, `CHRONOLOGY_MODES`×3
...
Чаще всего поминает: `S`×14, `DATA`×4
...
Чаще всего поминает: `MET`×21, `S`×10
...
Чаще всего поминает: `S`×23, `applyMetricsScope`×5, `updateScopeToggles`×5, `DATA`×4, `initializePhilosophyMetrics`×4
...
Чаще всего поминает: `S`×20, `applyMetricMode`×5, `generateMetricCoverageBlock`×4, `getMetricDescription`×3
...
- из `modules/render/similarity-overlay.js`: `clearSimilarityOverlay`, `showSimilarityOverlay`
...
Чаще всего поминает: `S`×10, `hasNodeClass`×8, `DATA`×7, `showTemporaryMessage`×4, `isNodeVisible`×4
...
Чаще всего поминает: `S`×33, `DATA`×26, `applyFilters`×17, `relationHint`×3, `philosopherPassesTraditions`×3
...
Чаще всего поминает: `S`×4, `selectedNodes`×4, `clearLinkSearch`×4, `clearLegendPhilSearch`×4, `DATA`×3
...
Чаще всего поминает: `DATA`×9, `S`×4, `emptyList`×4, `selectedEdges`×4, `pickConcepts`×3
...
Чаще всего поминает: `DATA`×9, `emptyList`×4, `openUniversalModal`×3, `highlightPhilosopherOnGraph`×3
...
Чаще всего поминает: `S`×6, `DATA`×3, `emit`×3, `emptyList`×3, `pickConcepts`×3