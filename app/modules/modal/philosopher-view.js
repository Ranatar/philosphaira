...
function makeLegendsEditable() {
      ...
      document.querySelectorAll('.legend-item').forEach(item => {
        ...
        if (checkbox) {
          ...
          //
          // ДЕФЕКТ (снят вместе с приглушением): у атрибута data-tip было ДВА
          // хозяина. Здесь ставится подсказка строки, а updatePhilosopherDimming
          // ставила свою («Отсечён отбором по традициям») и иначе СНИМАЛА атрибут.
