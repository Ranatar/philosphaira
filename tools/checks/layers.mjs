...
//
//   node tools/checks/layers.mjs                     список нарушающих рёбер
//   node tools/checks/layers.mjs имя <сущность>      куда ходит и откуда ходят к ней
//   node tools/checks/layers.mjs если <сущность> <модуль>   что даст перенос
import fs from 'node:fs';
import { КАРТА_ДЕРЕВА, КАРТА_ИМЁН, КОРЕНЬ, РАСКЛАДКА, ЭТАЖИ } from '../paths.mjs';
